          ...
          >
            <div className="flex justify-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-br from-[#00B894]/20 to-[#00C4FF]/20 rounded-full flex items-center justify-center border border-[#00B894]/30">
                <Shield className="w-10 h-10 text-[#00B894]" />
              </div>
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">
              <span className="text-white">Privacy </span>
              <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Policy</span>
            </h1>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold">
                  ...
                  <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Collect</span>
                </h2>
              </div>
              <div className="text-gray-300 space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-[#00B894] mb-3">Personal Information</h3>
                ...
                <div className="mt-6 pt-6 border-t border-white/10">
                  <h3 className="text-lg font-semibold text-[#00B894] mb-3">Automatically Collected Information</h3>
                  <p className="leading-relaxed mb-3">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[#00B894]/10 to-[#00C4FF]/10 rounded-lg flex items-center justify-center border border-[#00B894]/30">
                  <Eye className="w-6 h-6 text-[#00B894]" />
                </div>
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">
                  <span>2. How We Use Your </span>
                  <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Information</span>
                </h2>
              </div>
        ...
        <section className="bg-[#0B0A1C] text-white py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-[#00B894]/20 to-[#00C4FF]/20 rounded-lg flex items-center justify-center border border-[#00B894]/30">
                  <Lock className="w-6 h-6 text-[#00B894]" />
                </div>
                <h2 className="text-2xl lg:text-3xl font-bold">
                  <span className="text-white">3. Information Sharing and </span>
                  <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Disclosure</span>
                </h2>
              </div>
              <div className="text-gray-300 space-y-4">
                ...
                <ul className="list-disc list-inside ml-4 space-y-3 text-gray-300">
                  <li><strong className="text-[#00B894]">Service Providers:</strong> We may share information with trusted third-party service providers who assist us in operating our website and conducting our business, subject to confidentiality agreements.</li>
                  <li><strong className="text-[#00B894]">Legal Requirements:</strong> We may disclose information if required by law or in response to valid legal requests, such as court orders or government regulations.</li>
                  <li><strong className="text-[#00B894]">Business Transfers:</strong> In the event of a merger, acquisition, or sale of assets, your information may be transferred as part of the transaction.</li>
                  <li><strong className="text-[#00B894]">With Your Consent:</strong> We may share your information with your explicit consent or at your direction.</li>
                </ul>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">
                  <span>4. Data </span>
                  <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Security</span>
                </h2>
              </div>
              <div className="text-gray-700 space-y-4">
                <p className="leading-relaxed">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold">
                  ...
                  <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Retention</span>
                </h2>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            >
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">
                ...
                <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Choices</span>
              </h2>
              <div className="text-gray-700 space-y-4">
                <p className="leading-relaxed">
                ...
                <ul className="list-disc list-inside ml-4 space-y-2 text-gray-600">
                  <li><strong className="text-[#00B894]">Access:</strong> Request access to your personal information</li>
                  <li><strong className="text-[#00B894]">Correction:</strong> Request correction of inaccurate or incomplete information</li>
                  <li><strong className="text-[#00B894]">Deletion:</strong> Request deletion of your personal information</li>
                  <li><strong className="text-[#00B894]">Objection:</strong> Object to processing of your personal information</li>
                  <li><strong className="text-[#00B894]">Portability:</strong> Request transfer of your information to another service</li>
                  <li><strong className="text-[#00B894]">Withdrawal:</strong> Withdraw consent where processing is based on consent</li>
                </ul>
                <p className="mt-4 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-4">
                ...
                <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Technologies</span>
              </h2>
            ...
            >
              <h2 className="text-2xl font-bold mb-4">
                ...
                <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Links</span>
              </h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            >
              <h2 className="text-2xl font-bold mb-4">
                ...
                <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">Privacy</span>
              </h2>
              <p className="text-gray-300 leading-relaxed">
