...
const CareersHero = () => {
  return (
    <section className="relative overflow-hidden bg-[#0B0A1C] py-12 lg:py-16">
      ...
      <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-[#00B894] to-[#00C4FF] rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-[#00C4FF] to-[#00B894] rounded-full filter blur-3xl opacity-20 animate-pulse delay-1000"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <SafeLink href="#open-positions">
                <button className="group bg-gradient-to-r from-[#00B894] to-[#00C4FF] text-white font-semibold px-8 py-4 rounded-lg shadow-lg hover:shadow-lg hover:scale-105 transition-all duration-300 relative overflow-hidden">
              ...
              <SafeLink href="#why-join-syncops">
                <button className="group border-2 border-[#00B894] text-[#00B894] font-semibold px-8 py-4 rounded-lg hover:bg-[#00B894] hover:text-white transition-all duration-300 relative overflow-hidden">
                  <span className="relative z-10 flex items-center gap-2">
          ...
          <div className="relative">
            <div className="bg-[#1A1A2E]/90 backdrop-blur-xl rounded-2xl p-6  border border-white/10 shadow-2xl h-full w-full relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-8 relative z-10">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#00B894] rounded-full animate-pulse"></div>
                  <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#00B894] text-sm font-medium">LIVE</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-center mb-6 relative z-10">
                ...
                <div className="relative mb-4">
                  <div className="w-24 h-24 bg-gradient-to-br from-[#00B894]/20 to-[#00C4FF]/20 rounded-full flex items-center justify-center border border-[#00B894]/30 shadow-lg relative">
                  ...
                  {/* Glowing ring effect */}
                  <div className="absolute inset-0 w-24 h-24 bg-gradient-to-r from-[#00B894] to-[#00C4FF] rounded-full opacity-20 animate-pulse blur-sm"></div>
                </div>
              ...
              <div className="space-y-3 relative z-10">
                <div className="flex items-center gap-3 text-sm text-gray-300">
                  <div className="w-8 h-8 bg-gradient-to-br from-[#00B894]/20 to-[#00C4FF]/20 rounded-lg flex items-center justify-center border border-[#00B894]/30">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-300">
                  <div className="w-8 h-8 bg-gradient-to-br from-[#00C4FF]/20 to-[#00B894]/20 rounded-lg flex items-center justify-center border border-[#00C4FF]/30">
              ...
              <div className="absolute top-1/4 right-4 w-2 h-2 bg-[#00B894] rounded-full animate-pulse opacity-60"></div>
            ...
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-r from-[#00B894] to-[#00C4FF] rounded-full animate-bounce"></div>
            <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-r from-[#00C4FF] to-[#00B894] rounded-full animate-pulse"></div>
            <div className="absolute top-1/2 -right-6 w-4 h-4 bg-[#00B894] rounded-full animate-pulse delay-1000"></div>
