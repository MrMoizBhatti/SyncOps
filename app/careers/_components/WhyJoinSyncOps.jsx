    ...
    <div id="why-join-syncops" className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="relative bg-gradient-to-br from-white to-[#F9FCFE] rounded-3xl p-12 lg:p-16 shadow-2xl border border-gray-100">
          {/* Quote Icon */}
          <div className="mb-8">
            <div className="w-16 h-16 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-full flex items-center justify-center shadow-lg mx-auto">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-4 mb-2">
              <div className="w-12 h-12 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-full flex items-center justify-center">
            ...
            <div className="flex items-center justify-center gap-1">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-5 h-5 text-[#00F8B4]" fill="currentColor" viewBox="0 0 24 24">
