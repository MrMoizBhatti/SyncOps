...
const FinalCTA = () => {
  return (
    <section className="bg-gradient-to-br from-[#F9FCFE] via-white to-[#F0FCFF] text-[#1F3A56] py-20 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-[500px] h-[500px] bg-gradient-to-r from-[#00C4FF] to-[#00F8B4] rounded-full filter blur-3xl opacity-10 animate-pulse delay-1000"></div>
      
      {/* Floating Particles */}
      <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#00F8B4] rounded-full animate-bounce opacity-60"></div>
      <div className="absolute top-1/3 right-1/3 w-3 h-3 bg-[#00C4FF] rounded-full animate-pulse opacity-70"></div>
      <div className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-[#00F8B4] rounded-full animate-bounce delay-1000 opacity-50"></div>
      <div className="absolute bottom-1/3 right-1/4 w-4 h-4 bg-[#00C4FF] rounded-full animate-pulse delay-500 opacity-60"></div>
      <div className="absolute top-1/2 left-1/3 w-2 h-2 bg-[#00F8B4] rounded-full animate-pulse delay-1500 opacity-40"></div>
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-12 lg:p-16 border border-white/50 shadow-2xl">
            ...
            <div className="text-center">
              {/* Icon */}
              <div className="mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-full flex items-center justify-center shadow-lg mx-auto">
                  <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                  </svg>
                </div>
                {/* Glowing ring effect */}
                <div className="absolute inset-0 w-20 h-20 bg-gradient-to-r from-[#00F8B4] to-[#00C4FF] rounded-full opacity-30 animate-pulse blur-sm"></div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                <SafeLink href="#open-positions">
                  <button className="group bg-gradient-to-r from-[#00F8B4] to-[#00C4FF] text-white font-bold px-10 py-4 rounded-xl shadow-lg hover:shadow-[0_0_40px_rgba(0,248,180,0.5)] hover:scale-105 transition-all duration-300 relative overflow-hidden">
                ...
                <SafeLink href="#contact">
                  <button className="group border-2 border-[#00F8B4] text-[#00F8B4] font-bold px-10 py-4 rounded-xl hover:bg-[#00F8B4] hover:text-white transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,248,180,0.4)]">
          ...
          <div className="text-center mt-8">
            <SafeLink href="#open-positions">
              <button className="group text-gray-500 hover:text-[#00F8B4] transition-colors duration-300 flex items-center gap-2 mx-auto">
