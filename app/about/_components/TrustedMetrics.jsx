        ...
        {metrics.map((metric, index) => (
          ...
          >
            ...
            <div className="relative z-10 text-center">
              {/* Icon */}
              <div className="mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 mx-auto">
              ...
              {/* Number */}
              <div className="mb-4">
                <span className="text-4xl lg:text-5xl font-bold text-[#2D2D2D] group-hover:text-[#00F8B4] transition-colors duration-300">
                  {metric.number}
                </span>
                <span className="text-2xl lg:text-3xl font-bold text-[#00F8B4]">
                  {metric.suffix}
                </span>
              </div>
