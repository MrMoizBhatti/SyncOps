      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-[#1A1A2E]/90 backdrop-blur-xl rounded-2xl p-8 border border-white/10 shadow-2xl max-h-[450px] w-full">
              {/* Icon Grid */}
              <div className="grid grid-cols-3 gap-6">
                {/* Innovation Icon */}
                <div className="group bg-gradient-to-br from-[#00F8B4]/20 to-[#00C4FF]/20 rounded-xl p-6 border border-[#00F8B4]/30 hover:border-[#00F8B4]/50 hover:shadow-lg transition-all duration-300">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                    </svg>
                  </div>
                  <h3 className="text-white font-semibold text-sm mb-2">Innovation</h3>
                  <p className="text-gray-400 text-xs">Cutting-edge solutions</p>
                </div>

                {/* Technology Icon */}
                <div className="group bg-gradient-to-br from-[#00C4FF]/20 to-[#00F8B4]/20 rounded-xl p-6 border border-[#00C4FF]/30 hover:border-[#00C4FF]/50 hover:shadow-lg transition-all duration-300">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#00C4FF] to-[#00F8B4] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
                  </div>
                  <h3 className="text-white font-semibold text-sm mb-2">Technology</h3>
                  <p className="text-gray-400 text-xs">AI-powered tools</p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-[#00F8B4]/20 to-[#00C4FF]/20 rounded-xl p-6 border border-[#00F8B4]/30 hover:border-[#00F8B4]/50 hover:shadow-lg transition-all duration-300">
                  ...
                  <h3 className="text-white font-semibold text-sm mb-2">People</h3>
                  <p className="text-gray-400 text-xs">Expert team</p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-[#00C4FF]/20 to-[#00F8B4]/20 rounded-xl p-6 border border-[#00C4FF]/30 hover:border-[#00C4FF]/50 hover:shadow-lg transition-all duration-300">
                  ...
                  <h3 className="text-white font-semibold text-sm mb-2">Purpose</h3>
                  <p className="text-gray-400 text-xs">Meaningful impact</p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-[#00F8B4]/20 to-[#00C4FF]/20 rounded-xl p-6 border border-[#00F8B4]/30 hover:border-[#00F8B4]/50 hover:shadow-lg transition-all duration-300">
                  ...
                  <h3 className="text-white font-semibold text-sm mb-2">Growth</h3>
                  <p className="text-gray-400 text-xs">Scalable solutions</p>
                </div>
                ...
                <div className="group bg-gradient-to-br from-[#00C4FF]/20 to-[#00F8B4]/20 rounded-xl p-6 border border-[#00C4FF]/30 hover:border-[#00C4FF]/50 hover:shadow-lg transition-all duration-300">
                  ...
                  <h3 className="text-white font-semibold text-sm mb-2">Future</h3>
