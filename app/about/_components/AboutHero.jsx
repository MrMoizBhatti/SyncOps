...
const AboutHero = () => {
  return (
    <section className="relative overflow-hidden bg-[#0B0A1C] py-8 sm:py-10 md:py-12 lg:py-16">
      ...
      <div className="absolute top-10 left-5 sm:top-16 sm:left-10 md:top-20 md:left-20 w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 bg-gradient-to-r from-[#00F8B4] to-[#00C4FF] rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
      <div className="absolute bottom-10 right-5 sm:bottom-16 sm:right-10 md:bottom-20 md:right-20 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-gradient-to-r from-[#00C4FF] to-[#00F8B4] rounded-full filter blur-3xl opacity-20 animate-pulse delay-1000"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-2 sm:px-0">
              <SafeLink href="#team">
                <button className="group w-full sm:w-auto bg-gradient-to-r from-[#00F8B4] to-[#00C4FF] text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg shadow-lg hover:shadow-lg hover:scale-105 transition-all duration-300 relative overflow-hidden text-sm sm:text-base">
              ...
              <SafeLink href="#mission">
                <button className="group w-full sm:w-auto border-2 border-[#00F8B4] text-[#00F8B4] font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-[#00F8B4] hover:text-white transition-all duration-300 relative overflow-hidden text-sm sm:text-base">
                  <span className="relative z-10 flex items-center justify-center gap-2">
          ...
          <div className="relative order-1 lg:order-2">
            <div className="bg-[#1A1A2E]/90 backdrop-blur-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-white/10 shadow-2xl max-h-[400px] sm:max-h-[450px] md:max-h-[500px] w-full">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                {/* Innovation Icon */}
                <div className="group bg-gradient-to-br from-[#00F8B4]/20 to-[#00C4FF]/20 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 border border-[#00F8B4]/30 hover:border-[#00F8B4]/50 hover:shadow-lg transition-all duration-300">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                {/* Technology Icon */}
                <div className="group bg-gradient-to-br from-[#00C4FF]/20 to-[#00F8B4]/20 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 border border-[#00C4FF]/30 hover:border-[#00C4FF]/50 hover:shadow-lg transition-all duration-300">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#00C4FF] to-[#00F8B4] rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-3 md:mb-4 group-hover:scale-110 transition-transform duration-300">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                    </svg>
                  </div>
            ...
            {/* Floating Elements */}
            <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-[#00F8B4] to-[#00C4FF] rounded-full animate-bounce"></div>
            <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 w-4 h-4 sm:w-6 sm:h-6 bg-gradient-to-r from-[#00C4FF] to-[#00F8B4] rounded-full animate-pulse"></div>
            <div className="absolute top-1/2 -right-3 sm:-right-6 w-3 h-3 sm:w-4 sm:h-4 bg-[#00F8B4] rounded-full animate-pulse delay-1000"></div>
          </div>
        </div>
      </div>
    </section>
