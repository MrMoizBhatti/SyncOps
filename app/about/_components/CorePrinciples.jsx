      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-[#222222] mb-6">
            What <span className="bg-gradient-to-r from-[#00F8B4] to-[#00C4FF] bg-clip-text text-transparent">
              Drives Us
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {principles.map((principle, index) => (
            ...
            >
              {/* Glassmorphism card */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-white/20 hover:border-[#00F8B4]/30 transition-all duration-300 hover:scale-105 hover:shadow-2xl relative overflow-hidden">
                {/* Background gradient */}
                ...
                <div className="relative z-10">
                  ...
                  <div className={`w-20 h-20 bg-gradient-to-r ${principle.color} rounded-2xl flex items-center justify-center text-white shadow-lg mb-6 group-hover:scale-110 transition-transform duration-300 group-hover:shadow-[0_0_20px_rgba(0,248,180,0.4)]`}>
                    {principle.icon}
                  </div>
                  
                  <h3 className="text-xl font-bold text-[#222222] mb-4 group-hover:text-[#00F8B4] transition-colors duration-300">
                    {principle.title}
                  </h3>
