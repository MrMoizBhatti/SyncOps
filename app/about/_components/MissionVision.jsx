    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div className="text-center mb-20">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00F8B4]/10 to-[#00C4FF]/10 rounded-full px-6 py-2 mb-6">
          ...
          <span className="text-sm font-medium text-[#00F8B4]">Our Foundation</span>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 mb-20">
        ...
        <div className="group bg-white rounded-3xl p-12 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 relative overflow-hidden transform hover:scale-105">
          ...
          <div className="relative z-10">
            {/* Enhanced Icon */}
            <div className="mb-10">
              <div className="w-24 h-24 bg-gradient-to-br from-[#00F8B4] to-[#00C4FF] rounded-3xl flex items-center justify-center shadow-2xl group-hover:shadow-[0_20px_40px_rgba(0,248,180,0.3)] transition-all duration-500 group-hover:scale-110 group-hover:rotate-3">
            ...
            {/* Content */}
            <h3 className="text-4xl font-bold text-[#2D2D2D] mb-8 group-hover:text-[#00F8B4] transition-colors duration-500">
              Our Mission
            </h3>
          ...
          <div className="absolute top-8 right-8 w-4 h-4 bg-[#00F8B4] rounded-full animate-pulse opacity-60 group-hover:animate-bounce"></div>
          ...
          <div className="absolute top-1/2 right-4 w-2 h-2 bg-[#00F8B4] rounded-full animate-pulse delay-1000 opacity-40"></div>
        </div>

        {/* Vision Card */}
        <div className="group bg-white rounded-3xl p-12 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 relative overflow-hidden transform hover:scale-105">
          {/* Enhanced glowing background effect */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#00C4FF]/5 to-[#00F8B4]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          
          <div className="relative z-10">
            {/* Enhanced Icon */}
            <div className="mb-10">
              <div className="w-24 h-24 bg-gradient-to-br from-[#00C4FF] to-[#00F8B4] rounded-3xl flex items-center justify-center shadow-2xl group-hover:shadow-[0_20px_40px_rgba(0,196,255,0.3)] transition-all duration-500 group-hover:scale-110 group-hover:-rotate-3">
                <svg className="w-12 h-12 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="absolute bottom-8 left-8 w-3 h-3 bg-[#00F8B4] rounded-full animate-bounce opacity-50 group-hover:animate-pulse"></div>
          <div className="absolute top-1/2 right-4 w-2 h-2 bg-[#00C4FF] rounded-full animate-pulse delay-1000 opacity-40"></div>
        </div>
      </div>

      {/* Enhanced Bottom Stats */}
      <div className="bg-gradient-to-r from-[#00F8B4]/5 to-[#00C4FF]/5 rounded-3xl p-12 border border-[#00F8B4]/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="group text-center transform hover:scale-105 transition-all duration-300">
            <div className="w-20 h-20 bg-gradient-to-br from-[#00F8B4]/20 to-[#00C4FF]/20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:shadow-lg transition-all duration-300">
              <span className="text-3xl font-bold text-[#2D2D2D] group-hover:text-[#00F8B4] transition-colors duration-300">50+</span>
            </div>
          ...
          <div className="group text-center transform hover:scale-105 transition-all duration-300">
            <div className="w-20 h-20 bg-gradient-to-br from-[#00C4FF]/20 to-[#00F8B4]/20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:shadow-lg transition-all duration-300">
          ...
          <div className="group text-center transform hover:scale-105 transition-all duration-300">
            <div className="w-20 h-20 bg-gradient-to-br from-[#00F8B4]/20 to-[#00C4FF]/20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:shadow-lg transition-all duration-300">
              <span className="text-3xl font-bold text-[#2D2D2D] group-hover:text-[#00F8B4] transition-colors duration-300">24/7</span>
            </div>
