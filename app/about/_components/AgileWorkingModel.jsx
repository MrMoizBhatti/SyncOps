      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-[#222222] mb-6">
            How We <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">
              Work
            </span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-[#00B894] to-[#00C4FF] transform -translate-y-1/2 opacity-30"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-4">
            {steps.map((step, index) => (
              ...
              >
                {/* Step card */}
                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:border-[#00B894]/30 transition-all duration-300 hover:scale-105 hover:shadow-2xl relative overflow-hidden group-hover:shadow-[0_0_20px_rgba(0,184,148,0.2)]">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className={`w-16 h-16 mx-auto bg-gradient-to-r ${step.color} rounded-2xl flex items-center justify-center text-white shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300 group-hover:shadow-[0_0_20px_rgba(0,184,148,0.4)]`}>
                      {step.icon}
                    </div>
                    
                    <h3 className="text-lg font-bold text-[#222222] mb-2 group-hover:text-[#00B894] transition-colors duration-300">
                      {step.title}
                    </h3>
                ...
                {index < steps.length - 1 && (
                  <div className="lg:hidden flex justify-center mt-4">
                    <div className="w-8 h-8 bg-gradient-to-r from-[#00B894] to-[#00C4FF] rounded-full flex items-center justify-center">
