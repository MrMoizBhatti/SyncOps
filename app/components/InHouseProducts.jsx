...
export default function InHouseProducts() {
  return (
    <section className="py-24 bg-gradient-to-b from-[#0B0A1C] via-[#0F0E1F] to-[#0B0A1C] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#00B894]/10 via-[#00C4FF]/5 to-[#00B894]/10"></div>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-[#00B894]/5 to-[#00C4FF]/5 rounded-full filter blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <motion.div className="text-center mb-20" initial="initial" whileInView="animate" viewport={viewport} variants={stagger.container(0.06)}>
          <motion.div className="inline-block mb-6" variants={fadeUp(16)}>
            <span className="px-4 py-2 bg-gradient-to-r from-[#00B894]/20 to-[#00C4FF]/20 rounded-full text-sm text-[#00B894] border border-[#00B894]/30">
              Built In-House
            </span>
          </motion.div>
          <motion.h2 className="text-4xl md:text-6xl font-bold mb-6" variants={fadeUp(16)}>
            Our <span className="bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">
              ...
              >
                <div className={`group flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 items-center bg-white/5 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-white/10 hover:border-[#00C4FF]/40 transition-all duration-500 hover:shadow-2xl hover:shadow-[#00C4FF]/20 hover:bg-white/10`}>
                      ...
                      <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
                        {product.stats.map((stat, idx) => (
                          <div key={idx} className="bg-white/5 rounded-xl p-4 border border-white/10 text-center lg:text-left">
                            <div className="text-2xl font-bold bg-gradient-to-r from-[#00B894] to-[#00C4FF] bg-clip-text text-transparent">
                              {stat.value}
                            </div>
                  ...
                  <div className="flex-1">
                    <h3 className="text-3xl lg:text-4xl font-bold text-white mb-4 group-hover:text-[#00B894] transition-colors duration-300">
                      {product.title}
                    </h3>
                    ...
                    <ul className="space-y-3 mb-8">
                      {product.benefits.map((benefit, idx) => (
                        <li key={idx} className="flex items-start gap-3 text-gray-300">
                          <CheckCircle size={20} className="text-[#00B894] flex-shrink-0 mt-0.5" />
                          <span>{benefit}</span>
                        </li>
                      ))}
                    </ul>
                    ...
                    <SafeLink
                      href={product.href}
                      className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00B894] to-[#00C4FF] text-white font-semibold px-6 py-3 rounded-xl hover:shadow-lg hover:shadow-[#00B894]/30 transition-all duration-300 group/btn"
                    >
