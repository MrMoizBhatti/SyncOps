...
const MultiCloudBenefits = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#0B0A1C] via-[#0F1E2E] to-[#0B0A1C] relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-72 h-72 bg-gradient-to-r from-[#00C4FF] to-[#00B894] rounded-full filter blur-3xl opacity-10 animate-pulse delay-500"></div>
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-r from-[#00B894] to-[#00C4FF] rounded-full filter blur-3xl opacity-10 animate-pulse delay-1500"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              {/* Glow Effect */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#00B894]/10 to-[#00C4FF]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
              ...
              <div className="relative z-10">
                ...
                {/* Stats */}
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00B894]/20 to-[#00C4FF]/20 border border-[#00B894]/30 rounded-full px-4 py-2">
                  <div className="w-2 h-2 bg-[#00B894] rounded-full animate-pulse"></div>
                  <span className="text-sm font-medium text-[#00B894]">{benefit.stats}</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center mt-16 pt-8 border-t border-white/10">
          ...
          <SafeLink
            href="/contact"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-[#00B894] to-[#00C4FF] text-white font-semibold px-8 py-4 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
