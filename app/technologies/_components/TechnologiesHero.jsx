      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00B894]/20 to-[#00C4FF]/20 border border-[#00B894]/30 rounded-full px-4 py-2 mb-6">
              <div className="w-2 h-2 bg-[#00B894] rounded-full animate-pulse"></div>
              <span className="text-sm font-medium text-[#00B894]">Future-Ready Technology</span>
            </div>
            ...
            <div className="bg-[#1A1A2E]/90 backdrop-blur-xl rounded-2xl p-6 border border-white/10 shadow-2xl max-h-[380px] w-full">
              ...
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-2.5 h-2.5 bg-[#00B894] rounded-full animate-pulse"></div>
                  <div>
