          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Our carefully curated technology stack combines proven reliability with cutting-edge innovation, ensuring your applications are built on a solid foundation that scales with your business needs.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1F3A56] mb-2">Proven Reliability</h4>
                    <p className="text-gray-600 text-sm">Built on battle-tested technologies that power millions of applications worldwide.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1F3A56] mb-2">Scalable Architecture</h4>
                    <p className="text-gray-600 text-sm">Designed to grow with your business from startup to enterprise scale.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1F3A56] mb-2">Security First</h4>
                    <p className="text-gray-600 text-sm">Enterprise-grade security built into every layer of the technology stack.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1F3A56] mb-2">Future-Ready</h4>
                    <p className="text-gray-600 text-sm">Continuously updated with the latest technologies and best practices.</p>
                  </div>
                </div>
              </div>
            </div>
...
export default WhyChooseTechStack; 